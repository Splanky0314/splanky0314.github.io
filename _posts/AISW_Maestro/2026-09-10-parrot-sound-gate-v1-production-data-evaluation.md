...
subheading: "신규 15,879클립에서 확인한 운영 임계값과 대형조 recall 문제"
author: Daeun
categories: AISW_Maestro
date: 2026-09-10 00:00:00 +0900
description: "parrot-sound-gate v1.0.0을 신규 실데이터 15,879클립으로 평가해 앵무 recall 98.4%, 비앵무 FAR 11.5%의 원인을 분석하고 운영 임계값과 대형조 모사 데이터의 문제를 정리했습니다."
...
v1.0.0를 프리즈한 이후, 데이터가 기존 2,318클립 → 18,197클립으로 약 7.8배 확대되었다.
...
| 라벨  | 수     | 설명                                       |
| --- | -----: | ---------------------------------------- |
| 앵무  | 6,096 | unknown 5,795 + 확인 종 301                 |
| 비앵무 | 9,783 | 잡음 7,361, station 사람 2,118, 보호자 기준음성 304 |
...
| 지표, τ=0.0378    | 기존 데이터 2,318    | 신규 데이터 15,879           |
| --------------- | ---------------: | -----------------------: |
| 앵무 recall       | 100%            | **98.4%** = 5,999/6,096 |
| 앵무 mimic recall | 100%            | **93.2%** = 1,011/1,085 |
| 비앵무 FAR 전체      | 0.17% = 3/1,817 | **11.5%** = 1,127/9,783 |
| 보호자 기준음성 FAR    | 0.0% = 0/126    | **33.6%** = 102/304     |
| station 사람 FAR  | 0.4% = 3/789    | **6.2%** = 131/2,118    |
| 잡음 FAR          | 0.0% = 0/902    | **12.1%** = 894/7,361   |
| ROC-AUC         | 1.000           | **0.992**               |
...
![신규 데이터 confusion matrix](https://cdn.jsdelivr.net/gh/splanky0314/CDN/AISW_Maestro/2026-09-10-parrot-sound-gate-v1-production-data-evaluation/cm_new-labels-20260910.png)



*그림 3: 신규 데이터. 앵무 행은 recall 98.4%로 유지된다. 비앵무 행에서 1,127클립이 통과로 잘못 판정된다. 게이트의 존재 이유가 비앵무 차단이므로 비앵무 행의 통과 칸이 핵심 문제다.*



### 3-3. 점수 분포로 본 원인

![신규 데이터 점수 분포](https://cdn.jsdelivr.net/gh/splanky0314/CDN/AISW_Maestro/2026-09-10-parrot-sound-gate-v1-production-data-evaluation/score_dist_new-labels-20260910.png)
...
| 분류군, 유형              | n      | recall    | 비고                     |
| -------------------- | ------: | ---------: | ---------------------- |
| unknown, non_speech  | 4,957  | 99.6%     | prod 앵무                |
...
- 현상: 신규 잡음 894클립과 station 사람 131클립이 통과
...
- 비앵무 오통과: 신규 비앵무 9,783클립 중 11.5% = 1,127클립 통과
  - 사람 음성 전체 FAR 9.6%, v1 설계 목표는 2% 이하
